...
return [
    ...
    */
    ...
    'NGENIUS_CURRENCY'=>env('NGENIUS_CURRENCY', 'AED'),
    'NGENIUS_OPERATION'=>env('NGENIUS_OPERATION', 'purchase'),
    'NGENIUS_DIRECT_MUST_3DS'=>env('NGENIUS_DIRECT_MUST_3DS', true),
    'NGENIUS_PAYPAGE_SLIM'=>env('NGENIUS_PAYPAGE_SLIM', false),
    'NGENIUS_PAYPAGE_LANGUAGE'=>env('NGENIUS_PAYPAGE_LANGUAGE'),
    'NGENIUS_MASK_PAYMENT_INFO'=>env('NGENIUS_MASK_PAYMENT_INFO', true),
    'NGENIUS_PAYMENT_ATTEMPTS'=>env('NGENIUS_PAYMENT_ATTEMPTS', '3'),
