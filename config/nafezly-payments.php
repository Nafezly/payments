...
return [
    ...
    #OXAPAY
    /*
    * Merchant API key is used for both API authentication and webhook HMAC verification.
    * Payment types: invoice, white_label, static_address
    */
    'OXAPAY_MERCHANT_API_KEY'=>env('OXAPAY_MERCHANT_API_KEY'),
    'OXAPAY_BASE_URL'=>env('OXAPAY_BASE_URL','https://api.oxapay.com/v1'),
    'OXAPAY_PAYMENT_TYPE'=>env('OXAPAY_PAYMENT_TYPE','invoice'),
    'OXAPAY_CURRENCY'=>env('OXAPAY_CURRENCY','USD'),
    'OXAPAY_PAY_CURRENCY'=>env('OXAPAY_PAY_CURRENCY'),
    'OXAPAY_NETWORK'=>env('OXAPAY_NETWORK'),
    'OXAPAY_LIFETIME'=>env('OXAPAY_LIFETIME',60),
    'OXAPAY_FEE_PAID_BY_PAYER'=>env('OXAPAY_FEE_PAID_BY_PAYER'),
    'OXAPAY_UNDER_PAID_COVERAGE'=>env('OXAPAY_UNDER_PAID_COVERAGE'),
    'OXAPAY_TO_CURRENCY'=>env('OXAPAY_TO_CURRENCY'),
    'OXAPAY_AUTO_WITHDRAWAL'=>env('OXAPAY_AUTO_WITHDRAWAL'),
    'OXAPAY_MIXED_PAYMENT'=>env('OXAPAY_MIXED_PAYMENT'),
    'OXAPAY_CALLBACK_URL'=>env('OXAPAY_CALLBACK_URL'),
    'OXAPAY_RETURN_URL'=>env('OXAPAY_RETURN_URL'),
    'OXAPAY_THANKS_MESSAGE'=>env('OXAPAY_THANKS_MESSAGE'),
    'OXAPAY_DESCRIPTION'=>env('OXAPAY_DESCRIPTION'),
    'OXAPAY_SANDBOX'=>env('OXAPAY_SANDBOX',false),
    'OXAPAY_RENDER_PAYMENT_DETAILS'=>env('OXAPAY_RENDER_PAYMENT_DETAILS',true),
