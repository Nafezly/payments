...
class OpayPayment extends BaseController implements PaymentInterface
{
    ...
    public function __construct()
    {
        ...
        $this->verify_route_name = Route::has(config('nafezly-payments.VERIFY_ROUTE_NAME')) ? route(config('nafezly-payments.VERIFY_ROUTE_NAME')) : '';
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null)
    {
        ...
        $response = Http::withHeaders([
            ...
            "callbackUrl" => $this->verify_route_name ? ($this->verify_route_name . "?reference_id=" . $unique_id) : '',
            "cancelUrl" => $this->verify_route_name ? ($this->verify_route_name . "?reference_id=" . $unique_id) : '',
            "country" => "EG",
            "expireAt" => 780,
            "payMethod" => "BankCard",
            "productList" => [
            ...
            "reference" => $unique_id,
            "returnUrl" => $this->verify_route_name ? ($this->verify_route_name . "?reference_id=" . $unique_id) : '',
            "userInfo" => [
