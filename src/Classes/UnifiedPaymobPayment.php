...
class UnifiedPaymobPayment extends BaseController implements PaymentInterface
{
    private $paymob_public_key;
    private $paymob_secret_key;
    private $paymob_integration_ids;
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->post('https://accept.paymob.com/v1/intention/', [
                ...
                "payment_methods" => collect($this->paymob_integration_ids)
                    // clear null values if exists.
                    ->filter()
                    // convert all to int if numeric (because paymob won't accept id as string
                    // but you can send integration names too.
                    ->map(function ($id) {
